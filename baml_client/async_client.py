...
class BamlAsyncClient:
    ...
    async def ClassifyArticle(
      ...
      return cast(types.ArticleType, raw.cast_to(types, types, partial_types, False))
    
    async def ExtractAcquisitionInfo(
        self,
        text: str,
        baml_options: BamlCallOptions = {},
    ) -> types.AcquisitionInfo:
      options: BamlCallOptions = {**self.__baml_options, **(baml_options or {})}
      ...
      return cast(types.AcquisitionInfo, raw.cast_to(types, types, partial_types, False))
    
    async def ExtractCommodityInfo(
        self,
        text: str,
        baml_options: BamlCallOptions = {},
    ...
    async def ExtractMergerInfo(
      ...
      return cast(types.MergerInfo, raw.cast_to(types, types, partial_types, False))
...
class BamlStreamClient:
    ...
    def ClassifyArticle(
        ...
        text: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[Optional[types.ArticleType], types.ArticleType]:
      options: BamlCallOptions = {**self.__baml_options, **(baml_options or {})}
      __tb__ = options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      ...
      return baml_py.BamlStream[Optional[types.ArticleType], types.ArticleType](
        raw,
        lambda x: cast(Optional[types.ArticleType], x.cast_to(types, types, partial_types, True)),
        lambda x: cast(types.ArticleType, x.cast_to(types, types, partial_types, False)),
        self.__ctx_manager.get(),
      )
    
    def ExtractAcquisitionInfo(
        self,
        text: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[partial_types.AcquisitionInfo, types.AcquisitionInfo]:
      options: BamlCallOptions = {**self.__baml_options, **(baml_options or {})}
      __tb__ = options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      ...
      return baml_py.BamlStream[partial_types.AcquisitionInfo, types.AcquisitionInfo](
        raw,
        lambda x: cast(partial_types.AcquisitionInfo, x.cast_to(types, types, partial_types, True)),
        lambda x: cast(types.AcquisitionInfo, x.cast_to(types, types, partial_types, False)),
        self.__ctx_manager.get(),
      )
    
    def ExtractCommodityInfo(
        self,
        text: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[Optional[Union[List[Optional[types.Commodity]], Optional[None]]], Union[List[types.Commodity], Optional[None]]]:
      options: BamlCallOptions = {**self.__baml_options, **(baml_options or {})}
      __tb__ = options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      ...
      return baml_py.BamlStream[Optional[Union[List[Optional[types.Commodity]], Optional[None]]], Union[List[types.Commodity], Optional[None]]](
        raw,
    ...
    def ExtractMergerInfo(
        ...
        text: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[partial_types.MergerInfo, types.MergerInfo]:
      options: BamlCallOptions = {**self.__baml_options, **(baml_options or {})}
      __tb__ = options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      ...
      return baml_py.BamlStream[partial_types.MergerInfo, types.MergerInfo](
        raw,
        lambda x: cast(partial_types.MergerInfo, x.cast_to(types, types, partial_types, True)),
        lambda x: cast(types.MergerInfo, x.cast_to(types, types, partial_types, False)),
        self.__ctx_manager.get(),
      )
